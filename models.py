...
if not db(db.employee).count():
    db.employee.insert(name='Martha', position='Software', office='london', extension='1', startDate="2011/07/25", salary=100000)
    db.employee.insert(name='Gavin Cortez', position='Developer', office='london', extension='1', startDate="2011/07/25", salary=100000)
    db.employee.insert(name='Suki Burks', position='Assistant', office='london', extension='1', startDate="2011/07/25", salary=100000)
    db.employee.insert(name='Fiona Green', position='Support', office='london', extension='1', startDate="2011/07/25", salary=100000)
    db.employee.insert(name='Peanut', position='great', office='london', extension='1', startDate="2011/07/25", salary=100000)
db.commit()
